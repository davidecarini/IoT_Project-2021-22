...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7c0a458, const void *arg_0xb7c0a5f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7bbb8c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb7a65840), 
int (*key_eq_fn)(void *arg_0xb7a65c88, void *arg_0xb7a65e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb79349b8, int arg_0xb7934b10);
static double RandomUniform(void );
...
typedef TMilli SmartBraceletC$MilliTimer10sec$precision_tag;
typedef TMilli SmartBraceletC$MilliTimerBroadcastPairing$precision_tag;
typedef TMilli SmartBraceletC$MilliTimer60sec$precision_tag;
...
static void SmartBraceletC$SplitControl$startDone(error_t error);
#line 138
static void SmartBraceletC$SplitControl$stopDone(error_t error);
...
static void SmartBraceletC$MilliTimer10sec$fired(void );
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
uint8_t len);
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void SmartBraceletC$MilliTimerBroadcastPairing$fired(void );
#line 83
static void SmartBraceletC$MilliTimer60sec$fired(void );
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static error_t SmartBraceletC$SplitControl$start(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
uint8_t len);
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
static uint16_t SmartBraceletC$Random$rand16(void );
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void SmartBraceletC$MilliTimer10sec$startPeriodic(uint32_t dt);
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
static error_t SmartBraceletC$Ack$requestAck(
#line 53
message_t * msg);
#line 85
static bool SmartBraceletC$Ack$wasAcked(
#line 80
message_t * msg);
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void SmartBraceletC$MilliTimerBroadcastPairing$startPeriodic(uint32_t dt);
#line 78
static void SmartBraceletC$MilliTimerBroadcastPairing$stop(void );
#line 73
static void SmartBraceletC$MilliTimer60sec$startOneShot(uint32_t dt);




static void SmartBraceletC$MilliTimer60sec$stop(void );
# 35 "SmartBraceletC.nc"
message_t SmartBraceletC$packet[1000];

uint8_t SmartBraceletC$paired_device[1000];
uint8_t SmartBraceletC$role[1000];

uint8_t SmartBraceletC$KEY[1000][20];


uint8_t SmartBraceletC$bracelet_phase[1000];

uint8_t SmartBraceletC$lastPosition_x[1000];
uint8_t SmartBraceletC$lastPosition_y[1000];

uint8_t SmartBraceletC$counter[1000];

uint8_t SmartBraceletC$same_key_device[1000];
bool SmartBraceletC$locked[1000];



static inline void SmartBraceletC$sendPairingReq(void );
#line 78
static void SmartBraceletC$sendPairingResp(void );
#line 100
static void SmartBraceletC$sendPosition(void );
#line 138
static inline void SmartBraceletC$Boot$booted(void );
#line 151
static inline void SmartBraceletC$SplitControl$startDone(error_t err);
#line 166
static inline void SmartBraceletC$MilliTimerBroadcastPairing$fired(void );
...
static inline void SmartBraceletC$MilliTimer10sec$fired(void );





static inline void SmartBraceletC$MilliTimer60sec$fired(void );
...
static inline void SmartBraceletC$SplitControl$stopDone(error_t err);
...
static void SmartBraceletC$AMSend$sendDone(message_t *buf, error_t err);
#line 231
static inline message_t *SmartBraceletC$Receive$receive(message_t *buf, void *payload, uint8_t len);
# 53 "/opt/tinyos-main-2.1.2/tos/chips/atm128/timer/HplAtm128TimerCtrl8.nc"
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void SmartBraceletC$MilliTimer60sec$startOneShot(uint32_t dt){
#line 73
...
inline static void SmartBraceletC$MilliTimer60sec$stop(void ){
#line 78
...
#line 78
#line 64
inline static void SmartBraceletC$MilliTimer10sec$startPeriodic(uint32_t dt){
#line 64
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startPeriodic(1U, dt);
#line 64
}
#line 64
# 231 "SmartBraceletC.nc"
static inline message_t *SmartBraceletC$Receive$receive(message_t *buf, void *payload, uint8_t len)
#line 231
{
...
#line 242
    if (len == sizeof(pairing_msg_t )) {
        pairingMsg = (pairing_msg_t *)payload;

        if (__nesc_ntoh_uint8(pairingMsg->msg_type.nxdata) == 1) {
            sim_log_debug(173U, "radio_rec", "Device %d receives broadcast message from: %d\n", TOS_NODE_ID, __nesc_ntoh_uint8(pairingMsg->node_id_source.nxdata));
            SmartBraceletC$counter[sim_node()]++;
            if (__nesc_ntoh_uint8(pairingMsg->node_id_source.nxdata) % 2 != TOS_NODE_ID % 2) 
              {

                for (i = 0; i < 20; i++) {
                    if (__nesc_ntoh_uint8(pairingMsg->pairing_key[i].nxdata) != SmartBraceletC$KEY[sim_node()][i]) {
                        same_key = FALSE;
                        sim_log_debug(174U, "radio_rec", "Rejected Broadcast message because of different key...\n");
                        break;
                      }
                  }
              }
            else {
                sim_log_debug(175U, "radio_rec", "Rejected Broadcast message\n");
                same_key = FALSE;
              }

            if (same_key) {
                SmartBraceletC$same_key_device[sim_node()] = __nesc_ntoh_uint8(pairingMsg->node_id_source.nxdata);
                sim_log_debug(176U, "radio_rec", "The broadcast message received has the same pre-loaded key...\n");

                SmartBraceletC$bracelet_phase[sim_node()]++;
                SmartBraceletC$sendPairingResp();
              }
          }
        else 
          {

            SmartBraceletC$paired_device[sim_node()] = __nesc_ntoh_uint8(pairingMsg->node_id_source.nxdata);
            sim_log_debug(177U, "radio_rec", "Associated device %d with %d\n", TOS_NODE_ID, __nesc_ntoh_uint8(pairingMsg->node_id_source.nxdata));


            if (SmartBraceletC$role[sim_node()] == 0) {
                SmartBraceletC$MilliTimer60sec$startOneShot(60000);
              }
            else {

              if (SmartBraceletC$role[sim_node()] == 1) {
                  sim_log_debug(178U, "radio_rec", "%d starts the Timer10sec\n", TOS_NODE_ID);
                  SmartBraceletC$MilliTimer10sec$startPeriodic(10000);
                }
              }
          }
      }
      ...
      if (len == sizeof(position_msg_t ) && SmartBraceletC$bracelet_phase[sim_node()] == 2) {
          if (SmartBraceletC$role[sim_node()] == 0) {
              SmartBraceletC$MilliTimer60sec$stop();
              positionMsg = (position_msg_t *)payload;

              sim_log_debug(179U, "radio", "Status received (%s)\n", positionMsg->status);
              SmartBraceletC$lastPosition_x[sim_node()] = __nesc_ntoh_uint8(positionMsg->x.nxdata);
              SmartBraceletC$lastPosition_y[sim_node()] = __nesc_ntoh_uint8(positionMsg->y.nxdata);
              SmartBraceletC$MilliTimer60sec$startOneShot(60000);

              if (strcmp(positionMsg->status, "FALLING") == 0) {
                  sim_log_debug(180U, "radio_rec", "FALL ALARM!!!.\n");
                  sim_log_debug(181U, "radio_rec", "Position: (%d,%d)\n", __nesc_ntoh_uint8(positionMsg->x.nxdata), __nesc_ntoh_uint8(positionMsg->y.nxdata));
                }
            }
        }
      }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb76d6ac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb76d6ac8) {
#line 78
    case 8:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb76d6ac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
inline static error_t SmartBraceletC$Ack$requestAck(message_t * msg){
#line 59
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb73c59f8, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb73c59f8, addr, msg, len);
#line 80
...
#line 75
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb76d6108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb76d6108, msg, error);
#line 110
}
#line 110
...
inline static bool SmartBraceletC$Ack$wasAcked(message_t * msg){
#line 85
  unsigned char __nesc_result;
#line 85
...
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
inline static uint16_t SmartBraceletC$Random$rand16(void ){
#line 52
  unsigned short __nesc_result;
#line 52
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb76d4178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb76d4178, msg, payload, len);
#line 78
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t SmartBraceletC$SplitControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 104
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void SmartBraceletC$MilliTimerBroadcastPairing$startPeriodic(uint32_t dt){
#line 64
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startPeriodic(0U, dt);
#line 64
}
#line 64
# 151 "SmartBraceletC.nc"
static inline void SmartBraceletC$SplitControl$startDone(error_t err)
#line 151
{
  if (err == SUCCESS) {
      sim_log_debug(158U, "radio", "Bracelet %d successfully started!\n", TOS_NODE_ID);

      sim_log_debug(159U, "radio", "Bracelet %u in Pairing phase\n", TOS_NODE_ID);
      SmartBraceletC$MilliTimerBroadcastPairing$startPeriodic(400);
    }
  else {
      sim_log_error(160U, "radio", "Bracelet failed to start, retrying...\n");
      SmartBraceletC$SplitControl$start();
    }
}
...
#line 113
  SmartBraceletC$SplitControl$startDone(error);
#line 113
}
#line 113
# 96 "/opt/tinyos-main-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 191
{
  sim_log_debug(166U, "role", "Shutting down the mote %d... \n", TOS_NODE_ID);
  sim_log_debug(167U, "role", "Done! \n");
}
...
#line 138
  SmartBraceletC$SplitControl$stopDone(error);
#line 138
}
#line 138
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb73c5010, message_t * msg, error_t error){
#line 100
  switch (arg_0xb73c5010) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb73c5010, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb7890650){
#line 75
  switch (arg_0xb7890650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb7890650);
#line 75
      break;
#line 75
    }
...
#line 75
# 78 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void SmartBraceletC$MilliTimerBroadcastPairing$stop(void ){
#line 78
...
#line 57
  if (!SmartBraceletC$locked[sim_node()]) {
      pairing_msg_t *rcm = (pairing_msg_t *)SmartBraceletC$Packet$getPayload(&SmartBraceletC$packet[sim_node()], sizeof(pairing_msg_t ));


      sim_log_debug(148U, "radio_send", "Creating the pairing message...\n");
      __nesc_hton_uint8(rcm->msg_type.nxdata, 1);
      for (i = 0; i < 20; i++) {
          __nesc_hton_uint8(rcm->pairing_key[i].nxdata, SmartBraceletC$KEY[sim_node()][i]);
        }
      __nesc_hton_uint8(rcm->node_id_source.nxdata, TOS_NODE_ID);

      sim_log_debug(149U, "radio_send", "Sending the pairing message with source ID:%d \n", TOS_NODE_ID);


      if (SmartBraceletC$AMSend$send(AM_BROADCAST_ADDR, &SmartBraceletC$packet[sim_node()], sizeof(pairing_msg_t )) == SUCCESS) {
          SmartBraceletC$locked[sim_node()] = TRUE;
        }
    }
}
...
#line 166
{
  sim_log_debug(161U, "timer", "MilliTimerBroadcastPairing Fired.\n");
  if (SmartBraceletC$paired_device[sim_node()] == 0) {
      SmartBraceletC$sendPairingReq();
    }
  else {
    SmartBraceletC$MilliTimerBroadcastPairing$stop();
    }
}
...
#line 177
{
  sim_log_debug(162U, "timer", "MilliTimer10sec Fired.\n");
  SmartBraceletC$sendPosition();
}
...
#line 183
{
  sim_log_debug(163U, "timer", "MilliTimer60sec Fired.\n");
  sim_log_debug(164U, "timer", "***************************MISSING ALARM*************************\n");
  sim_log_debug(165U, "radio_rec", "Last Position of the child detected: (%d,%d)\n", SmartBraceletC$lastPosition_x[sim_node()], SmartBraceletC$lastPosition_y[sim_node()]);
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb74233a8){
#line 83
  switch (arg_0xb74233a8) {
#line 83
    case 0U:
#line 83
      SmartBraceletC$MilliTimerBroadcastPairing$fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      SmartBraceletC$MilliTimer10sec$fired();
#line 83
      break;
#line 83
    case 2U:
#line 83
      SmartBraceletC$MilliTimer60sec$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb74233a8);
#line 83
      break;
#line 83
    }
...
#line 140
  sim_log_debug(157U, "boot", "Application booted on bracelet %u\n", TOS_NODE_ID);
  for (i = 0; i < 20; i++) {
      SmartBraceletC$KEY[sim_node()][i] = (TOS_NODE_ID - 1) / 2;
    }
  SmartBraceletC$role[sim_node()] = (TOS_NODE_ID + 1) % 2;
  SmartBraceletC$SplitControl$start();
}
...
#line 78
{
  if (!SmartBraceletC$locked[sim_node()]) {
      ...
      sim_log_debug(150U, "radio_send", "%d creates the special message to stop pairing phase...\n", TOS_NODE_ID);


      SmartBraceletC$Ack$requestAck(&SmartBraceletC$packet[sim_node()]);
      __nesc_hton_uint8(rcm->msg_type.nxdata, 2);
      __nesc_hton_uint8(rcm->node_id_source.nxdata, TOS_NODE_ID);

      if (SmartBraceletC$AMSend$send(SmartBraceletC$same_key_device[sim_node()], &SmartBraceletC$packet[sim_node()], sizeof(pairing_msg_t )) == SUCCESS) {
          SmartBraceletC$locked[sim_node()] = TRUE;
          sim_log_debug(151U, "radio_pack", "Special message of node %d sent!\n", TOS_NODE_ID);
        }
    }
}
...
#line 55
{
  ...
  /*SmartBraceletAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 8);
...
# 198 "SmartBraceletC.nc"
static void SmartBraceletC$AMSend$sendDone(message_t *buf, error_t err)
#line 198
{

  if (&SmartBraceletC$packet[sim_node()] == buf) {

      SmartBraceletC$locked[sim_node()] = FALSE;
    }
  else {
      sim_log_debug(168U, "radio_send", "Error in sending pairing packet...");
    }


  if (SmartBraceletC$Ack$wasAcked(&SmartBraceletC$packet[sim_node()]) && SmartBraceletC$bracelet_phase[sim_node()] == 1) {
      sim_log_debug_clear(169U, "radio_ack", "\tACK message received at time %s\n", sim_time_string());
      SmartBraceletC$bracelet_phase[sim_node()]++;
    }
  else {
#line 213
    if (SmartBraceletC$bracelet_phase[sim_node()] == 1 && SmartBraceletC$Ack$wasAcked(&SmartBraceletC$packet[sim_node()]) == SUCCESS) {
        sim_log_error(170U, "radio_ack", "Ack not received!\n");
        SmartBraceletC$sendPairingResp();
      }
    }
  if (SmartBraceletC$Ack$wasAcked(&SmartBraceletC$packet[sim_node()]) && SmartBraceletC$bracelet_phase[sim_node()] == 2) {
      sim_log_debug_clear(171U, "radio_ack", "\tACK position message received by node %d\n", TOS_NODE_ID);
    }
  else {
#line 221
    if (SmartBraceletC$bracelet_phase[sim_node()] == 2) {
        sim_log_error(172U, "radio_ack", "Ack position message not received!\n");
        SmartBraceletC$sendPosition();
      }
    }
}
...
#line 102
  if (!SmartBraceletC$locked[sim_node()]) {
      position_msg_t *positionMsg = (position_msg_t *)SmartBraceletC$Packet$getPayload(&SmartBraceletC$packet[sim_node()], sizeof(position_msg_t ));


      sim_log_debug(152U, "radio_send", "%d creates the position message...\n", TOS_NODE_ID);

      __nesc_hton_uint8(positionMsg->x.nxdata, SmartBraceletC$Random$rand16());
      __nesc_hton_uint8(positionMsg->y.nxdata, SmartBraceletC$Random$rand16());
      random = SmartBraceletC$Random$rand16() % 10;

      sim_log_debug(153U, "radio_send", "Generated status %d \n", random);
      if (random < 3) {
...
#line 122
      sim_log_debug(154U, "radio_send", "%d send status %s \n", TOS_NODE_ID, positionMsg->status);
      sim_log_debug(155U, "radio_send", "Sending the position message: (%d,%d)\t", __nesc_ntoh_uint8(positionMsg->x.nxdata), __nesc_ntoh_uint8(positionMsg->y.nxdata));


      SmartBraceletC$Ack$requestAck(&SmartBraceletC$packet[sim_node()]);


      if (SmartBraceletC$AMSend$send(SmartBraceletC$paired_device[sim_node()], &SmartBraceletC$packet[sim_node()], sizeof(position_msg_t )) == SUCCESS) {
          SmartBraceletC$locked[sim_node()] = TRUE;
          sim_log_debug_clear(156U, "radio_pack", "Status:%s\n", positionMsg->status);
        }
    }
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "SmartBraceletC$paired_device"))
  {
    *addr = (uintptr_t)&SmartBraceletC$paired_device[__nesc_mote];
    *size = sizeof(SmartBraceletC$paired_device[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBraceletC$role"))
  {
    *addr = (uintptr_t)&SmartBraceletC$role[__nesc_mote];
    *size = sizeof(SmartBraceletC$role[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBraceletC$KEY"))
  {
    *addr = (uintptr_t)&SmartBraceletC$KEY[__nesc_mote];
    *size = sizeof(SmartBraceletC$KEY[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBraceletC$bracelet_phase"))
  {
    *addr = (uintptr_t)&SmartBraceletC$bracelet_phase[__nesc_mote];
    *size = sizeof(SmartBraceletC$bracelet_phase[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBraceletC$lastPosition_x"))
  {
    *addr = (uintptr_t)&SmartBraceletC$lastPosition_x[__nesc_mote];
    *size = sizeof(SmartBraceletC$lastPosition_x[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBraceletC$lastPosition_y"))
  {
    *addr = (uintptr_t)&SmartBraceletC$lastPosition_y[__nesc_mote];
    *size = sizeof(SmartBraceletC$lastPosition_y[__nesc_mote]);
    return 0;
  }
  ...
  if (!strcmp(varname, "SmartBraceletC$same_key_device"))
  {
    *addr = (uintptr_t)&SmartBraceletC$same_key_device[__nesc_mote];
    *size = sizeof(SmartBraceletC$same_key_device[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBraceletC$locked"))
  {
    *addr = (uintptr_t)&SmartBraceletC$locked[__nesc_mote];
    *size = sizeof(SmartBraceletC$locked[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  SmartBraceletC$paired_device[__nesc_mote] = 0;
  memset((void *)&SmartBraceletC$role[__nesc_mote], 0, sizeof SmartBraceletC$role[__nesc_mote]);
  memset((void *)&SmartBraceletC$KEY[__nesc_mote], 0, sizeof SmartBraceletC$KEY[__nesc_mote]);
  SmartBraceletC$bracelet_phase[__nesc_mote] = 0;
  SmartBraceletC$lastPosition_x[__nesc_mote] = 0;
  SmartBraceletC$lastPosition_y[__nesc_mote] = 0;
  SmartBraceletC$counter[__nesc_mote] = 0;
  memset((void *)&SmartBraceletC$same_key_device[__nesc_mote], 0, sizeof SmartBraceletC$same_key_device[__nesc_mote]);
  SmartBraceletC$locked[__nesc_mote] = FALSE;
